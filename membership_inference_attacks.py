...
class black_box_benchmarks(object):
    ...
    def _mem_inf_via_corr(self):
        ...
        print('For membership inference attack via correctness, the attack acc is {acc1:.3f}, with train acc 1.00 and test acc {acc3:.3f}'.format(acc1=mem_inf_acc, acc2=t_tr_acc, acc3=t_te_acc) )
        return
